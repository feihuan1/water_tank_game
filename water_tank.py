...
def use_card(player_tank, card_to_use, player_cards, opponent_tank):
    ...
    if card_to_use in (1,5,10):
        ...
        opponent_tank = opponent_tank//2 + 1
...
def computer_play(computer_tank, computer_cards, water_cards_pile, power_cards_pile, opponent_tank):
    ...
    if 38 <= computer_tank <= 42 and "DMT" in computer_cards:
        ...
        playing_card = 'DMT'
        (computer_tank, opponent_tank) = use_card(computer_tank, playing_card, computer_cards, opponent_tank)
        ...
        if 38 <= opponent_tank <= 42:
            if "SOH" in computer_cards:
                ...
                playing_card="DOT"
                (computer_tank, opponent_tank) = use_card(computer_tank, playing_card, computer_cards, opponent_tank)
        elif 75 <= (opponent_tank + computer_tank//2) <= 85:
            if "SOH" in computer_cards:
                print(f"computer is using: SOH")
                playing_card = "SOH"
                (computer_tank, opponent_tank) = use_card(computer_tank, playing_card, computer_cards, opponent_tank)
            ...
            playing_card = computer_cards[2]
            (computer_tank, opponent_tank) = use_card(computer_tank, playing_card, computer_cards, opponent_tank)

    
    computer_cards.append(get_card_from_pile(power_cards_pile if isinstance(playing_card, str) else water_cards_pile, 0))
